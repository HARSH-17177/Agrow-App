              ...
              children: [
                ...
                ElevatedButton.icon(
                    onPressed: canResendEmail
                        ? sendVerificationEmail
                        : null, //can resend email is used here as on ce the reset button is pressed and the email is send no one can again press it for 5 seconds
                    icon: const Icon(
                      Icons.email,
                      size: 32,
                    ),
                ...
                TextButton(
                    onPressed: () => FirebaseAuth.instance
                        .signOut(), //can resend email is used here as on ce the reset button is pressed and the email is send no one can again press it for 5 seconds
